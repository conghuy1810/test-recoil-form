...
export function getPathInObj(obj, path, defaultValue = undefined, ancestors) {
  if (ancestors?.length) {
    let prefix = "";
...
export function setPathInObj(obj, path, fieldValue, ancestors) {
  if (path && obj) {
...
export function isDeepEqual(obj1, obj2, eq) {
